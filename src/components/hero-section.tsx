    ...
    return (
        <>
            <motion.section
                ...
                <div className={"absolute inset-0 bg-[radial-gradient(75%_75%_at_center_center,rgb(0,123,255,0.5)_15%,rgb(14,0,36,0.5)_78%,transparent)]"} />
                {/* Planet Logic */}
                <div className={"absolute size-64 md:size-96 bg-synergy-blue rounded-full border border-white/20 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[radial-gradient(50%_50%_at_16.8%_18.3%,white,rgb(0,123,255)_37.7%,rgb(139,92,246))] shadow-[-20px_-20px_50px_rgb(255,255,255,0.5),-20px_-20px_80px_rgb(255,255,255,0.1),0_0_50px_rgb(0,123,255)]"} />
                ...
                <div className={"container relative mt-16"}>
                    <h1 className={"text-6xl md:text-[120px] md:leading-none font-bold bg-white tracking-tighter bg-[radial-gradient(100%_100%_at_top_left,white,white,rgb(0,123,255,0.5))] bg-clip-text text-transparent text-center"}>AUTOMATIZA TU NEGOCIO</h1>
                    <p className={"text-lg md:text-xl max-w-3xl mx-auto text-white/70 mt-5 text-center"}>Transformamos PYMEs españolas con automatizaciones inteligentes que simplifican procesos y multiplican resultados. Tu departamento técnico externo.</p>
